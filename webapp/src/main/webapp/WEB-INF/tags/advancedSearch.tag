...
<form action="${searchUrl}" method="get" class="search-form search-form-${variant} ${hasActiveFilters ? 'search-form-has-active-filters' : ''} ${hasSearchQuery ? 'search-form-submit-visible' : ''}" data-navbar-search>
    <c:choose>
